package com.inditex.core.products.infrastructure.adapter.out.rest;
...
/**
 * Driven adapter implementing {@link ProductsPort} over Spring's {@link RestClient}.
 */
@Component
class ProductsAdapter implements ProductsPort {
    ...
    ProductsAdapter(RestClient existingProductsRestClient) {
