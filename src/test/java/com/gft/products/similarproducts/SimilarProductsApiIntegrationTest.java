...
class SimilarProductsApiIntegrationTest {
    ...
    void resolvesSimilarProductsConcurrentlyRatherThanSequentially() {
        ...
        // 150ms per call keeps a comfortable margin under the 500ms test timeout.
        // Sequential fan-out of 3 calls would take ~900ms+ (delay plus per-call HTTP
        // overhead); this generous bound proves concurrency without being timing-flaky.
